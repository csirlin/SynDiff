...
store_folder_name = '/home/colter/hdd6_colter/synthrad_h5_sparse/'
...
mri_train_concat, ct_train_concat = concat_middle_ns(paired_train, num = 3, gap = 5)
print(f"Concatenating {len(paired_val)} training images")
mri_val_concat, ct_val_concat = concat_middle_ns(paired_val, num = 3, gap = 5)
print(f"Concatenating {len(paired_test)} training images")
mri_test_concat, ct_test_concat = concat_middle_ns(paired_test, num = 3, gap = 5)
...
save_data(store_folder_name, 'data_train_mri.mat', mri_train_concat)
print(f"Saving ct_train")
save_data(store_folder_name, 'data_train_ct.mat', ct_train_concat)
print(f"Saving mri_val")
save_data(store_folder_name, 'data_val_mri.mat', mri_val_concat)
print(f"Saving ct_val")
save_data(store_folder_name, 'data_val_ct.mat', ct_val_concat)
print(f"Saving mri_test")
save_data(store_folder_name, 'data_test_mri.mat', mri_test_concat)
print(f"Saving ct_test")
save_data(store_folder_name, 'data_test_ct.mat', ct_test_concat)
